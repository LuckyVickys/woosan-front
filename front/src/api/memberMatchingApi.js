...
export const applyMatching = async (requestDTO) => {
    try {
        ...
        console.log('매칭 요청이 성공적으로 생성되었습니다.');
        return res.data;
    } catch (error) {
...
export const getMembers = async (matchingId) => {
    try {
        ...
        console.log('모임원 목록을 성공적으로 가져왔습니다.');
        return res.data;
    } catch (error) {
...
export const getPendingRequestsByBoardId = async (matchingId) => {
    try {
        ...
        console.log('가입 대기 중인 요청을 성공적으로 가져왔습니다.');
        return res.data;
    } catch (error) {
...
export const cancelMatchingRequest = async (matchingId, memberId) => {
    try {
        ...
        console.log('매칭 대기가 성공적으로 취소되었습니다.');
        return res.data;
    } catch (error) {
