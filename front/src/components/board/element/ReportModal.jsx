    ...
    <div className="report-modal-background" onClick={onClose}>
      <div className="report-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="report-modal-body">
          신고 유형
          <div className="input type-input" onSelect={handleSelectType}>
            {selectedType}
          </div>
          내용
          <textarea
            ...
            onChange={(e) =>
              setReport({ ...report, complaintReason: e.target.value })
            }
          />
          첨부파일
          <input
        ...
        <div className="report-form-buttons">
          <button className="report-save-button" onClick={handleClickReportAdd}>
            보내기
          </button>
